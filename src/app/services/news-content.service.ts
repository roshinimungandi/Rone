...
import { HomeContent, NewsSection, NewsStory } from '../models/news.model';
...
export class NewsContentService {
  private readonly content: HomeContent = {
    leadStory: {
      ...
      body: [
        'BRUSSELS, April 20 (Reuters) â€” Delegates from 14 nations convened in Brussels on Sunday for an emergency round of talks aimed at fast-tracking a multilateral trade corridor agreement, as surging freight insurance premiums threatened to choke global supply chains for the second time in three years.',
        'The sessions, chaired by the European Union\'s Trade Commissioner and attended by representatives from the United States, China, India, Brazil, and nine other major trading nations, come after a week in which freight insurance rates rose a further 18 percent â€” pushing the cumulative increase since January to nearly 40 percent.',
    ...
    spotlightStory: {
      ...
      body: [
        'TAIPEI, April 20 (Reuters) â€” Several of the world\'s largest semiconductor contract manufacturers are revising their product roadmaps to prioritise chips designed for edge artificial intelligence workloads, as demand from consumer electronics softens and orders from industrial and healthcare customers surge.',
        'Three people familiar with the planning said major foundries are reallocating capacity on mature process nodes â€” typically 28 nanometres and above â€” to serve customers building AI inference chips for factory automation, medical imaging equipment, and smart infrastructure.',
        '"The story of the last two years was data centre AI. The story of the next three years is edge AI," said one semiconductor analyst at a Taipei-based investment firm. "And the chips for edge AI look very different â€” lower power, real-time processing, purpose-built for specific tasks."',
    ...
    topHeadlines: [
      {
        ...
        body: [
          'WASHINGTON, April 20 (Reuters) â€” Senior officials at three of the world\'s major central banks delivered strikingly similar messages over the weekend: interest rate reductions are possible later this year, but only if inflation data provides greater clarity than current readings allow.',
      ...
      },
      {
        ...
        body: [
          'LONDON, April 20 (Reuters) â€” Diesel futures climbed to their highest level in six weeks on Monday as a series of unplanned refinery outages in the U.S. Gulf Coast and northern Europe tightened distillate supplies, even as rerouted crude cargoes pressured the front end of the oil curve.',
          ...
          'Analysts at two major investment banks maintained their second-quarter Brent forecasts in the range of $85â€“$92 per barrel, citing a volatile but range-bound outlook given the competing pressures of refinery tightness and rerouting flows.',
      ...
      },
      {
        ...
        body: [
          'NEW YORK, April 20 (Reuters) â€” Several large retail chains are quietly accelerating trials of compact urban store formats as footfall data from suburban locations disappoints, marking a strategic pivot that could reshape their real estate portfolios over the next two to three years.',
          'Three major grocery and general merchandise retailers are opening stores of between 8,000 and 15,000 square feet in city-centre locations â€” roughly a third of the size of their standard suburban units â€” targeting commuters, city workers, and residents who prefer frequent, smaller shopping trips to less regular bulk purchases.',
        ...
        stories: [
          {
            ...
            body: [
              ...
              'The core fiscal dispute centres on whether the incoming government can use a temporary exemption clause in the constitutional debt brake to fund a proposed infrastructure investment programme valued at approximately â‚¬150 billion over ten years. The centre-right bloc has resisted any loosening of the fiscal rules, while the social democrats argue the clause is legally available and economically necessary.',
              ...
              'Analysts tracking the talks said the infrastructure argument was likely to be resolved through a compromise that separates the investment vehicle from the core federal budget â€” potentially through an off-balance-sheet fund of the kind used by previous governments, though critics say such structures undermine fiscal transparency.',
          ...
          },
          {
            ...
            body: [
              'CHICAGO, April 20 (Reuters) â€” Agricultural commodity exporters in the midwestern United States reported improved vessel booking conditions this week as rail operators cleared the last significant accumulation of freight cars that had been stuck waiting near the Gulf Coast, ending a congestion episode that had depressed soybean and corn export activity for nearly a fortnight.',
              ...
              'Soybean basis levels â€” the premium or discount relative to Chicago Board of Trade futures â€” firmed at several interior locations, reflecting the improved logistics outlook. Corn basis was also slightly stronger, though export demand for U.S. corn has been softer than for soybeans given competitive pricing from South American origins.',
        ...
        stories: [
          {
            ...
            body: [
              'NEW YORK, April 20 (Reuters) â€” U.S. technology shares outpaced the broader market in Monday\'s afternoon session as investors rotated into growth names following a cluster of upbeat enterprise software and cloud infrastructure earnings reports released over the weekend, while utilities and rate-sensitive sectors fell as Treasury yields ticked higher.',
          ...
          },
          {
            ...
            body: [
              ...
              'Sterling was flat at 1.2385. The pound has been range-bound for several weeks as investors assessed mixed signals from the UK economy â€” stronger-than-expected growth data offset by still-elevated services inflation.',
            ],
          },
          {
            id: 'markets-003',
            ...
            body: [
              'LONDON, April 20 (Reuters) â€” Copper prices edged higher on Monday, extending a modest recovery from last week\'s lows as inventories registered in London Metal Exchange warehouses declined for a fourth consecutive reporting session and concerns about mine supply disruptions in two major producing countries came back into focus.',
              ...
              'LME warehouse stocks fell by 2,850 tonnes to 118,300 tonnes â€” their lowest level since late February. Analysts said the drawdown reflected genuine tightness in the prompt physical market rather than speculative inventory movements, with several smelters reporting difficulty securing spot concentrate.',
              ...
              'On the demand side, Chinese property sector data remains a drag. New home starts fell for the eighth consecutive month in March, weighing on construction-related copper demand. However, analysts noted that grid investment â€” driven by renewable energy expansion â€” was partly offsetting the property weakness.',
        ...
        stories: [
          {
            ...
            body: [
              'SAN FRANCISCO, April 20 (Reuters) â€” Artificial intelligence "copilot" tools â€” software assistants that help employees with tasks ranging from writing code to drafting emails and summarising documents â€” are moving out of cautious pilot programmes at large enterprises and into formal procurement and deployment phases, according to technology buyers and vendors interviewed by Reuters.',
              ...
              'More speculative use cases â€” including autonomous agents that plan and execute multi-step business processes â€” are still in early testing at most organisations, with buyers wary of the reliability and auditability challenges they present.',
          ...
          },
          {
            ...
            body: [
              'SAN FRANCISCO, April 20 (Reuters) â€” Corporate security teams are rapidly expanding deployments of passkey authentication â€” a technology that replaces passwords with cryptographic credentials stored on users\' devices â€” after early adopters reported significant reductions in account takeover incidents and help desk workload.',
              ...
              'Three large employers â€” a financial institution, a healthcare system, and a technology company â€” shared data with Reuters showing account recovery requests had fallen between 35 and 60 percent in the months following mandatory passkey rollouts, compared with the equivalent period a year earlier.',
              ...
              'The shift also reflects changing attacker behaviour. Security researchers at two firms said they had observed a marked increase in adversarial investment in social engineering attacks â€” attempts to trick users through phone calls or fake websites â€” as the technical barriers to credential theft rise.',
          ...
          },
          {
            ...
            body: [
              ...
              'Latest-generation low-earth-orbit networks have cut median round-trip latency to around 25â€“40 milliseconds for airborne users â€” well below the 600-millisecond typical of geostationary satellite systems and comparable to ground-based broadband in many markets.',
